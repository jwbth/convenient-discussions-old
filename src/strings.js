export default {
  ...
  refreshPage: 'Обновить страницу (R)',
  goToPrevNewMsg: 'Перейти к предыдущему новому сообщению (W)',
  goToNextNewMsg: 'Перейти к следующему новому сообщению (S)',
  goToFirstUnseenMsg: 'Перейти к первому непросмотренному сообщению (S)',
}
